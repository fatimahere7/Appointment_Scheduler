...
<script>
	...
	$(function(){
        $('#schedule_settings').submit(function(e){
            ...
            start_loader()
            $.ajax({
                url:_base_url_+"Master.php?f=save_sched_settings",
                data: $(this).serialize(),
                method:"POST",
                dataType:"json",
                error:err=>{
...
<script src="http://localhost/Scheduler_Project/plugins/moment/moment.min.js"></script>
<script src="http://localhost/Scheduler_Project/plugins/daterangepicker/daterangepicker.js"></script>
